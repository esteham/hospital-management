...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>Welcome to the Medical Team</h1>
            <p>Dr. {{ $name }}, your journey with {{ config('app.name') }} begins now</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="welcome-section">
                <h2 style="color: #1f2937; margin-top: 15px;  margin-bottom: 10px; font-weight: 600;">
                    Your Digital Protal is Ready!
                </h2>
                <p style="color: #6b7280; margin-bottom: 25px;">
                    We're thrilled to welcome you to our platform. Your account has been configured with all the tools you need to provide exceptional patient care.
                </p>
            ...
            <div class="checklist">
                ...
                <div class="checklist-item priority-high">
                    ...
                    <div>
                        <strong>Complete Professional Profile</strong><br>
                        <small style="color: #6b7280;">Add your specialization, bio, and photo</small>
                    </div>
                </div>
                ...
                <div class="checklist-item priority-medium">
                    ...
                    <div>
                        <strong>Set Availability Schedule</strong><br>
                        <small style="color: #6b7280;">Define your consultation hours</small>
                    </div>
                </div>
            ...
            <div class="features-grid">
                <div class="feature-item">
                    ...
                    <small style="color: #6b7280; display: block;">Manage appointments efficiently</small>
                </div>
                <div class="feature-item">
                    <span style="font-size: 24px; display: block; margin-bottom: 8px;">👥</span>
                    <strong>Patient Management</strong>
                    <small style="color: #6b7280; display: block;">Complete patient records</small>
                </div>
                <div class="feature-item">
                    <span style="font-size: 24px; display: block; margin-bottom: 8px;">💬</span>
                    <strong>Secure Messaging</strong>
                    <small style="color: #6b7280; display: block;">HIPAA compliant communication</small>
                </div>
                <div class="feature-item">
                    <span style="font-size: 24px; display: block; margin-bottom: 8px;">📊</span>
                    <strong>Analytics Dashboard</strong>
                    <small style="color: #6b7280; display: block;">Track your practice metrics</small>
                </div>
            </div>
            ...
            <div class="support-section">
                ...
                <div style="color: #166534;">
                    ...
                    <strong>📧 Email:</strong> doctors-support@{{ config('app.name') }}.com<br>
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 30px; border-top: 1px solid #e5e7eb;">
                <p style="color: #6b7280; margin-bottom: 20px;">
                    We're committed to providing you with the best tools to deliver exceptional patient care.
                </p>
                <p style="font-weight: 600; color: #1f2937;">
                    Warm regards,<br>
                    <span style="color: #3b82f6;">Medical Operations Team</span><br>
